...
with_node \
  ...
  --target "/Users/ahmadbasraa/Documents/chaosCorpo/ios/Pods/Target Support Files/Pods-chaosCorpo/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-document-picker" "expo-file-system" "expo-font" "expo-keep-awake"
